...
<div class="col-md-12 p-5 pt-2" style="padding-left: 25px; padding-right: 25px;">
    ...
    <form action="{{ url('/majalah') }}" method="GET" class="mb-3">
    <div class="input-group" style="width: 300px;">
        <input type="text" name="search" class="form-control" placeholder="Cari ISSN, Penerbit" value="{{ request('search') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{ route('majalah.destroy', $majalah->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
