...
<div class="col-md-12 p-5 pt-2"> <!-- Expanded the width to full (12 columns) -->
    <h3 class="dashboard" style="margin-left: 1%; margin-top: 2%;">Piringan Hitam</h3>
    <hr class="border border-dark border-1 opacity-30">
    <form action="{{ url('/piringanhitam') }}" method="GET" class="mb-3">
                ...
                <table class="table table-bordered table-hover" style="width: 100%;">
                    <thead>
                        <tr class="table-dark">
                            ...
                            <th style="width: 12%;">Penyumbang</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ str_replace( 'http://127.0.0.1:8000/D:\XAMPP\tmp\phpF3AA.tmp','/public/cover/',$piringanhitam->cover) }}" class="img-thumbnail" style="width:200px" /></td>
                            <td>{{ $piringanhitam->lagu }}</td>
                            <td>{{ $piringanhitam->deskripsi }}</td>
                            <td>{{ $piringanhitam->rak }}</td>
                            <td class="text-center">
                                <a href="/piringanhitam/edit/{{$piringanhitam->id}}" class="edit" title="Edit" data-toggle="tooltip">
                                    <i class="material-icons">&#xE254;</i>
                                </a>
                                <form action="{{ route('piringanhitam.destroy', $piringanhitam->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
