...
<html lang="en">
  ...
  <body>
    ...
    <div class="judul">
        <img src="/Img/book no bg.png" style="align-items: center; width: 15%;">
    </div>
    <div class="ukuran">
        <h1 style="text-align: center; margin-top: -2%;">Buku</h1>
    </div>
    <div class="content row">
        @foreach ($buku as $bukus)
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h3>Judul: {{$bukus->judul}}</h3>
                <p>Deskripsi: {{$bukus->deskripsi}}</p>
                <p>Rak: {{$bukus->rak}}</p>
            </div>
        </div>
        @endforeach
