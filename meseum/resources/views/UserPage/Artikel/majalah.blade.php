...
<html lang="en">
  ...
  <body>
    ...
    <div class="judul">
        <img src="/Img/majlaah.png" style="align-items: center; width: 15%;">
    </div>
    <div class="ukuran">
        <h1 style="text-align: center; margin-top: 1%;">Majalah</h1>
    </div>
    <div class="content row">
        @foreach ($majalah as $majalahs)
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h3>Judul: {{$majalahs->judul}}</h3>
                <p>Deskripsi: {{$majalahs->deskripsi}}</p>
                <p>Rak: {{$majalahs->rak}}</p>
            </div>
        </div>
        @endforeach
    </div>
