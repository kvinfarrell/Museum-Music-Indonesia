...
<html lang="en">
  ...
  <body>
    ...
    <div class="content row">
        @foreach ($alatmusik_tradisional as $alatmusiktradisional)
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h4>Nama Instrumen: {{$alatmusiktradisional->nama_instrumen}}</h4>
                <p>Daerah : {{$alatmusiktradisional->daerah}}</h1>
                <!-- <p>Penyumbang : {{$alatmusiktradisional->penyumbang}}</p> -->
                <p>Quantity : {{$alatmusiktradisional->quantity}}</p>
            </div>
        </div>
        @endforeach
    </div>
