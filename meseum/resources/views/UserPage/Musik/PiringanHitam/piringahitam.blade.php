  ...
  <body>
    ...
    <div class="container-image-logo">
        <div class="image-logo-1">
          <div class="content">
           <a href="/Musik/Piringan Hitam/piringanhitamindonesia.html"><img src="/Img/musik_indonesia_1x1-removebg-preview.png" style="margin-left: 35%;" alt="" class="drum"></a>
            <h4 style="margin-bottom: 5%; margin-left: 35%;">Musik Indonesia</h4>
          </div>
        </div>
        <div class="logo2">
            <img src="/Img/piringan_hitam_1x1-removebg-preview.png" style="margin-left: 35%;" alt="" class="not">
            <h4 style="margin-left: 55%; text-align: center;">Piringan Hitam</h4>
        </div>
       <div class="image-logo-4">
        <div class="content">
            <a href="/Musik/Piringan Hitam/piringanhitamdaerah.html"><img src="/Img/ikon_tradisional_1x1-removebg-preview.png " class="drumtwo"></a>
          <h4 style="margin-left: -46%;">Musik Daerah</h4>
        </div>
      </div>
        <div class="image-logo-3">
          <div class="content">
            <a href="/Musik/Piringan Hitam/piringanhitaminternasional.html"><img src="/Img/musik internasional.png" class="drumtri"></a>
