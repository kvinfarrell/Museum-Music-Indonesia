...
<html lang="en">
  ...
  <body>
    ...
    <div class="back" onclick="goBack()">
        <img src="/Img/tombol_back-removebg-preview.png" alt="Back Button">
    </div>
    <div class="judul">
    ...
    <div class="card-box h-100">
        <img src="{{ asset($piringanhitams->cover) }}" alt="Foto memorabilia" class="img-fluid consistent-size">
        <div class="card-content">
          <h5></h5>
           <b> <h3>Nama Album: {{ $piringanhitams->lagu }}</h3></b>
