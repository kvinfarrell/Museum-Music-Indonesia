...
<html lang="en">
  ...
  <body>
    ...
    <div class="ukuran">
        <h1 style="text-align: center; margin-top: -2%;">Kaset Indonesia</h1>
    </div>
    <div class="content row">
        @foreach ($kaset as $kasets)
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h3>Lagu: {{$kasets->lagu}}</h3>
                <p>Deskripsi: {{$kasets->deskripsi}}</p>
                <p>Rak: {{$kasets->rak}}</p>
            </div>
        </div>
        @endforeach
    ...
    <footer class="footer">
      <div class="info">
        ...
        <div class="information" style="flex: 1; padding-right: 20px;">
            ...
            <p>
              <img src="/Img/instagram.png"style="width: 20px; margin-right: 10px;">@museummusikindonesia<br>
              <img src="/Img/facebook.png"  style="width: 20px; margin-right: 10px;">Museum MUSIK Indonesia<br>
              <img src="/Img/mail.png" style="width: 20px; margin-right: 10px;">museummusikindonesia@yahoo.co.id
            </p>
        </div>
